...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 我要判卷 </nav>
<div class="page-container">
        ...
        <div class="modal-dialog" style="width: 800px;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="demoModalLabel">选择出卷范围</h4>
                </div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">您已经选择：
        <span class="alreadyselect"></span>
        <button type="button" class="btn btn btn-primary" data-dismiss="modal" id="already">已完成</button>
    </div>
    <div class="modal fade" id="alreadyModal" data-backdrop="static">
        <div class="modal-dialog" style="width: 800px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">请给试卷命名</h4>
                </div>
                <div class="modal-body" style="height: 245px;">
                    <form method="post">
                        <label for="zhang">请给试卷命名</label>
                        <input class="form-control" name="zhang" id="examinationName">
                    </form>
                </div>
                <!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="final-submit">提交</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
<script type="text/javascript" src="/exam/static/backpages/js/makePaper.js"></script>
<!--/_footer /作为公共模版分离出去-->
